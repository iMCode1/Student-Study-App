...
class login_page : Fragment() {
    ...
    override fun onCreateView(
        ...
        val guestText = view.findViewById<TextView>(R.id.continueAsGuestText)

        signUpText.setOnClickListener {
            findNavController().navigate(R.id.action_login_page_to_register_page2)
        }

        guestText.setOnClickListener {
            findNavController().navigate(R.id.action_login_page_to_dashboard_page)
        }
