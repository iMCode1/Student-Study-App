 ...
 * Use the [leaderboard_page.newInstance] factory method to
 * create an instance of this fragment.
 */
class leaderboard_page : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment leaderboard_page.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            leaderboard_page().apply {
